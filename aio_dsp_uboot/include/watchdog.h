...
#define INIT_FUNC_WATCHDOG_RESET	init_func_watchdog_reset,
    ...
    #if defined(CONFIG_EXT_WATCHDOG)
        extern void bf_ext_watchdog_reset(void);
        extern void bf_ext_watchdog_init(void);
        #define INIT_FUNC_WATCHDOG_INIT     bf_ext_watchdog_init,
        #define INIT_FUNC_WATCHDOG_RESET    bf_ext_watchdog_reset,
    #else
        #define INIT_FUNC_WATCHDOG_INIT
        #define INIT_FUNC_WATCHDOG_RESET
    #endif /* defined(CONFIG_EXT_WATCHDOG) */
#endif
 ...
 */
    ...
    #if defined(CONFIG_EXT_WATCHDOG)
        #if defined(__ASSEMBLY__)
            #define WATCHDOG_RESET bl   bf_ext_wd_reset
        #else
            extern void bf_ext_wd_reset(void);
            #define WATCHDOG_RESET      bf_ext_wd_reset
        #endif
    ...
    #endif /* #if defined(CONFIG_EXT_WATCHDOG) */
