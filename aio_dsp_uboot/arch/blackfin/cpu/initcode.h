...
static inline void early_ext_watchdog_init(void)
{
    bfin_write_PORTFIO_DIR(0x0028);/* set PF5 as output */
    SSYNC();
    bfin_write_PORTFIO_CLEAR(0x0028);/* set PF5 = LOW */
	SSYNC();
    bfin_write_PORTFIO_INEN(0);/* set PF5 input disable */
	SSYNC();
    bfin_write_PORTFIO_POLAR(0);/* set PF5 polar */
	SSYNC();
    bfin_write_PORTFIO_SET(0x0028);/* set PF5 = HIGH */
	SSYNC();
    asm("nop;nop;nop;");
    bfin_write_PORTFIO_CLEAR(0x0028);/* set PF5 = LOW */
	SSYNC();
...
__attribute__((always_inline))
static inline void early_ext_watchdog_reset(void)
{
    bfin_write_PORTFIO_SET(0x0028);/* set PF5 = HIGH */
	SSYNC();
    asm("nop;nop;nop;");
